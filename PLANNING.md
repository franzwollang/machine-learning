...
| M1 — Canonical clustering objective | in progress — #44 C–D merge DAG + rank/excess-mass screens + DM sibling collapse landed default-off; geometric screens overlap connected-manifold nulls so promotion still blocked; repaired benchmarks (#45) |
