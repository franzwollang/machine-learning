...
| M1 — Canonical clustering objective | in progress — #44 flag stays off. #48 studentized floor wired (default-off); awaiting-flip still blocked pending normal-path re-check |
