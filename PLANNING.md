...
| M1 — Canonical clustering objective | blocked — #44 flag stays off. #48: D1 keeps the S-curve sheet in the null family and `φ=0.25` calibrated-provisional. The default-off hit-mass guard removes the sole null accept over seeds 5–19 (1/266 unguarded → 0/266 guarded) while preserving 15/15 composite roots; corrected DM still overlaps nulls on 69% of reads and is not the valley floor. Cadence sweep 2026-09-10 remained green through nulls 30/30, hierarchy 5/5, and linked tori 5/5; it was stopped before nested/bimodal/weak so the tested merge could publish promptly. #45: `tissue_mass` and descent A/B fired their kill criteria; component-only child nulls landed, and nested+bimodal pure children are clean on 20/20 reads, leaving the weak-child and child-envelope checks. No default or ceiling change is authorized. |
...
#45 (tissue mass fraction, descent semantics B then A), and #28 cleanup. A1 records
